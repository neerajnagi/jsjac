...
function handleIQ(oIQ) {
            ...
            function doLogin(oForm) {
                ...
                // reset
                selfdata = {"Id":oForm.username.value , "Name":oForm.displayName.value, "Status":1, "ProfilePictureUrl":oForm.profilePictureUrl.value} 
				oDbg = new JSJaCConsoleLogger(4);
                try {

                   // if (oForm.http_base.value.substr(0, 5) === 'ws://' || oForm.http_base.value.substr(0, 6) === 'wss://') {
                        con = new JSJaCWebSocketConnection({
                            httpbase : "ws://primetimesingles.net/ws/",
                            oDbg : new JSJaCConsoleLogger(4)
                        });
                    ...
                    oArgs = new Object();
                    oArgs.domain = "test.primetimesingles.net";
...
(function ($) {
 ...
 {"Id":"chris@primetimesingles.net/jsjac_simpleclient","Status":1,"Name":"chris", "ProfilePictureUrl":"profile_pic/chris.png"   }   
   ...
   , {"Id":"chris2@test.primetimesingles.net/jsjac_simpleclient","Status":1,"Name":"chris2", "ProfilePictureUrl":"profile_pic/chris2.png"   }   
    , {"Id":"chris3@test.primetimesingles.net/jsjac_simpleclient","Status":1,"Name":"chris3", "ProfilePictureUrl":"profile_pic/chris3.png"   }  
	 , {"Id":"chris4@test.primetimesingles.net/jsjac_simpleclient","Status":1,"Name":"chris4", "ProfilePictureUrl":"profile_pic/chris4.png"   }   
	  , {"Id":"chris5@test.primetimesingles.net/jsjac_simpleclient","Status":1,"Name":"chris5", "ProfilePictureUrl":"profile_pic/chris5.png"   } ]);
        return chat;
    };
})(jQuery);
